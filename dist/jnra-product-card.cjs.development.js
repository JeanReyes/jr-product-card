...
var ShoppingPage = function ShoppingPage() {
  ...
  return React__default.createElement("div", null, React__default.createElement("h1", null, "ShoppingPage"), React__default.createElement("hr", null), React__default.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'row',
      flexWrap: 'wrap'
    ...
    }, React__default.createElement(ProductImage, {
      className: "custom-image"
    }), React__default.createElement(ProductTitle, {
      className: "text-white"
    }), React__default.createElement(ProductButtons, {
    ...
    }, React__default.createElement(ProductCard.Image, {
      className: "custom-image"
    }), React__default.createElement(ProductCard.Title, {
      title: 'hola mundo',
      className: "text-white"
    }), React__default.createElement(ProductCard.Buttons, {
      className: "custom-buttons"
    }));
  }))));
};
